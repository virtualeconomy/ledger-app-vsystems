...
0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xc7, 0xe3, 0x8f, 0xe3, 0x1f, 0xf7, 0x1f, 0xff, 
  0x3f, 0xfe, 0x7f, 0xfe, 0x7f, 0xfe, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
  };

#ifdef OS_IO_SEPROXYHAL
#include "os_io_seproxyhal.h"
const bagl_icon_details_t C_icon_vsys = { GLYPH_icon_vsys_WIDTH, GLYPH_icon_vsys_HEIGHT, 1, C_icon_vsys_colors, C_icon_vsys_bitmap };
#endif // OS_IO_SEPROXYHAL
